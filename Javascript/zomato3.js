...
let smallArray=data.map((ele,index)=>{
    
    return {name:ele.info.name, rating:ele.info.rating.rating_text, image:ele.info.image.url, cfo:ele.info.cfo.text}
})
console.log(smallArray);

/*Print each object inside array*/
smallArray.forEach((ele,index)=>{
    console.log(ele)
})
